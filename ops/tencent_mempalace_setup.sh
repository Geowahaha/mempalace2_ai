...
# weekend/off-hours test alternative: BTCUSD
SYMBOL=XAUUSD
DRY_RUN=false
...
LLM_FAILOVER_FAILURE_THRESHOLD=2
LLM_FAILOVER_COOLDOWN_SEC=20
LLM_FAILOVER_RUNTIME_PATH=${APP_DIR}/data/llm_failover_runtime.json
LOCAL_FALLBACK_MODELS=qwen2.5:0.5b,gemma3:1b-it-qat
SELF_IMPROVEMENT_ENABLED=true
SELF_IMPROVEMENT_MODEL_NAME=gemma3:1b-it-qat
SELF_IMPROVEMENT_TIMEOUT_SEC=90
SELF_IMPROVEMENT_MAX_TOKENS=220
